  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.heroSection} style={{ padding: '80px 24px 60px', textAlign: 'center', maxWidth: 720, margin: '0 auto' }}>
        ...
        <div style={{ padding: '12px 20px', borderRadius: 10, background: 'rgba(109,184,138,0.06)', border: '1px solid rgba(109,184,138,0.2)', display: 'inline-block' }}>
          ...
          <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', marginBottom: 10 }}>We have specialized muscle-preservation plans for Ozempic/Wegovy users</div>
          <div style={{ display: 'flex', gap: 8, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/form/glp1" style={{ fontSize: 11, color: '#6db88a', textDecoration: 'none', fontWeight: 600 }}>GLP-1 Training →</Link>
            <span style={{ color: 'rgba(255,255,255,0.2)' }}>·</span>
            <Link to="/form/glp1-nutrition" style={{ fontSize: 11, color: '#6db88a', textDecoration: 'none', fontWeight: 600 }}>GLP-1 Nutrition →</Link>
          </div>
        </div>
