  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.heroSection} style={{ padding: '80px 24px 60px', textAlign: 'center', maxWidth: 720, margin: '0 auto' }}>
        ...
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '8px 16px', borderRadius: 20, background: 'rgba(109,184,138,0.08)', border: '1px solid rgba(109,184,138,0.2)', marginBottom: 20, fontSize: 12, color: 'rgba(255,255,255,0.65)', lineHeight: 1.6 }}>
          <span style={{ fontSize: 16 }}>ℹ️</span>
          <span><strong style={{ color: '#6db88a' }}>GLP-1 medications</strong> (Ozempic, Wegovy, Mounjaro) cause rapid weight loss—but up to 40% can be muscle without the right training.</span>
        </div>
        <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, marginBottom: 32, maxWidth: 540, margin: '0 auto 32px' }}>
          Get a free AI training plan built to preserve it—3× full-body per week, high protein, optimized for low-energy days.
        </p>
