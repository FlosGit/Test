    ...
    <div className={styles.page}>
      ...
      <section className={styles.heroSection} style={{ padding: '80px 24px 60px', textAlign: 'center', maxWidth: 720, margin: '0 auto' }}>
        ...
        <h1 style={{ fontSize: 'clamp(32px, 6vw, 56px)', fontWeight: 900, lineHeight: 1.1, marginBottom: 20, color: '#fff' }}>
          Built around <span style={{ color: '#c8a96e' }}>your body</span>,<br />schedule & goals.
        </h1>
        <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, marginBottom: 32, maxWidth: 540, margin: '0 auto 32px' }}>
          Get a fully personalized training or nutrition plan in minutes. Evidence-based programming, calculated from your exact stats. Free to start—no subscription.
        </p>
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 24 }}>
          <Link to="/form/training" style={{ display: 'inline-block', padding: '16px 40px', borderRadius: 50, background: 'linear-gradient(135deg,#a88a50,#c8a96e)', color: '#000', fontSize: 14, fontWeight: 800, letterSpacing: 1, textDecoration: 'none', boxShadow: '0 8px 28px rgba(200,169,110,0.35)', transition: 'transform 0.2s' }}
            onMouseEnter={e => e.currentTarget.style.transform = 'translateY(-2px)'}
            onMouseLeave={e => e.currentTarget.style.transform = 'translateY(0)'}>
            Get Training Plan →
          </Link>
          <Link to="/form/nutrition" style={{ display: 'inline-block', padding: '16px 40px', borderRadius: 50, background: 'transparent', border: '1.5px solid rgba(200,169,110,0.4)', color: '#c8a96e', fontSize: 14, fontWeight: 800, letterSpacing: 1, textDecoration: 'none', transition: 'all 0.2s' }}
            onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(200,169,110,0.8)'; e.currentTarget.style.background = 'rgba(200,169,110,0.08)' }}
            onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(200,169,110,0.4)'; e.currentTarget.style.background = 'transparent' }}>
            Get Nutrition Plan →
          </Link>
        </div>
        <div style={{ padding: '12px 20px', borderRadius: 10, background: 'rgba(109,184,138,0.06)', border: '1px solid rgba(109,184,138,0.2)', display: 'inline-block', marginBottom: 16 }}>
          ...
          <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.6)', marginBottom: 10 }}>Specialized muscle preservation plans available</div>
          <div style={{ display: 'flex', gap: 8, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/form/glp1" style={{ padding: '8px 16px', borderRadius: 20, background: 'rgba(109,184,138,0.15)', border: '1px solid rgba(109,184,138,0.35)', color: '#6db88a', fontSize: 11, fontWeight: 700, letterSpacing: 0.5, textDecoration: 'none', transition: 'all 0.2s' }}
              onMouseEnter={e => e.currentTarget.style.background = 'rgba(109,184,138,0.25)'}
              onMouseLeave={e => e.currentTarget.style.background = 'rgba(109,184,138,0.15)'}>
              GLP-1 Training →
            </Link>
            <Link to="/form/glp1-nutrition" style={{ padding: '8px 16px', borderRadius: 20, background: 'rgba(109,184,138,0.15)', border: '1px solid rgba(109,184,138,0.35)', color: '#6db88a', fontSize: 11, fontWeight: 700, letterSpacing: 0.5, textDecoration: 'none', transition: 'all 0.2s' }}
              onMouseEnter={e => e.currentTarget.style.background = 'rgba(109,184,138,0.25)'}
              onMouseLeave={e => e.currentTarget.style.background = 'rgba(109,184,138,0.15)'}>
              GLP-1 Nutrition →
            </Link>
        ...
        <div style={{ marginTop: 8, fontSize: 11, color: 'rgba(255,255,255,0.25)', letterSpacing: 0.5 }}>No subscription · Delivered in 1-5 minutes</div>
      </section>
