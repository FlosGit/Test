    ...
    <div className={styles.page}>
      ...
      <section className={styles.heroSection} style={{ padding: '80px 24px 60px', textAlign: 'center', maxWidth: 720, margin: '0 auto' }}>
        ...
        <h1 style={{ fontSize: 'clamp(32px, 6vw, 56px)', fontWeight: 900, lineHeight: 1.1, marginBottom: 20, color: '#fff' }}>
          Built for your body.<br />Ready in <span style={{ color: '#c8a96e' }}>minutes</span>.
        </h1>
        <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, marginBottom: 32, maxWidth: 540, margin: '0 auto 32px' }}>
          Get a fully personalized training or nutrition plan calculated from your exact stats—progressive overload built in, delivered to your inbox instantly.
        </p>
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 24 }}>
          <Link to="/form/training" style={{ display: 'inline-block', padding: '16px 32px', borderRadius: 50, background: 'var(--gold)', color: '#000', fontSize: 14, fontWeight: 800, letterSpacing: 1, textDecoration: 'none', transition: 'transform 0.2s' }}
        ...
        <div style={{ marginTop: 20, fontSize: 11, color: 'rgba(255,255,255,0.25)', letterSpacing: 0.5 }}>Free to start · No subscription · Delivered in 1-5 minutes</div>
        <div style={{ marginTop: 32, padding: '12px 20px', borderRadius: 10, background: 'rgba(109,184,138,0.06)', border: '1px solid rgba(109,184,138,0.2)', display: 'inline-block' }}>
          ...
          <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', marginBottom: 10 }}>Specialized muscle preservation plans available</div>
          <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
            <Link to="/form/glp1" style={{ fontSize: 11, color: '#6db88a', textDecoration: 'none', fontWeight: 600 }}>Training Plan →</Link>
            <span style={{ color: 'rgba(255,255,255,0.2)' }}>·</span>
            <Link to="/form/glp1-nutrition" style={{ fontSize: 11, color: '#6db88a', textDecoration: 'none', fontWeight: 600 }}>Nutrition Plan →</Link>
          </div>
        </div>
      </section>
